        ...
        >
          ...
          <div class="p-4">
            ...
            <template v-else>
              ...
              <div
                v-else
                class="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-center text-xs text-gray-500 dark:border-dark-700 dark:bg-dark-900 dark:text-dark-400"
              >
                {{ t('version.upToDate') }}
              </div>
            </template>
