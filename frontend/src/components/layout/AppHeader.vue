  ...
  <header class="glass sticky top-0 z-30 border-b border-gray-200/50 dark:border-dark-700/50">
    <div class="flex h-16 items-center justify-between px-4 md:px-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <div
          v-if="user"
          class="hidden items-center gap-2 rounded-lg bg-gray-100 px-3 py-1.5 dark:bg-dark-900 sm:flex"
        >
          <svg
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          ...
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-lg bg-gray-950 text-sm font-medium text-white shadow-sm dark:bg-white dark:text-gray-950">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
