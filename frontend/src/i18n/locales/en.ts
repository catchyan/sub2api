export default {
  ...
  setup: {
    title: 'Site Setup',
    description: 'Configure your service instance',
    database: {
  ...
  admin: {
    ...
    settings: {
      ...
      site: {
        ...
        siteSubtitlePlaceholder: 'Reliable access, clear usage, controlled delivery.',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: 'Welcome',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">This platform helps you operate AI service access with clear routing, account pools, key distribution, and billing controls.</p><p style="margin-bottom: 12px;"><b>Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li><b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li><b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li><b>Key Distribution</b> - Generate independent API Keys for users</li><li><b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes.</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
    ...
    user: {
      welcome: {
        title: 'Welcome',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Create an API key, connect it to your application, and start using AI services through this controlled access point.</p><p style="margin-bottom: 12px;"><b>Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>Create API Key</li><li>Copy key to your application</li><li>Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started.</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
